...
- גרש ומושגים: גרש יחיד (׳) סביב מושגים ומונחים; גרשיים (״) לציטוט ישיר של דברי אנשים בלבד.

━━━ תיקוני גרש — בצע לפי הסדר ━━━

שלב א׳ — מילית יחס + ה"א + גרש:
סרוק ומצא: [ב/ל/כ/מ] + ה + ׳...׳
תקן: מחק את ה"א, השאר את מילית היחס ישירות לפני הגרש.
  לה'ברית היהודית' ← שגוי    →    ל'ברית היהודית' ← נכון
  בה'שמאל' ← שגוי             →    ב'שמאל' ← נכון
  מה'ימין' ← שגוי              →    מ'ימין' ← נכון
  כה'מדינה' ← שגוי             →    כ'מדינה' ← נכון

שלב ב׳ — ה"א הידיעה בתוך גרש:
סרוק ומצא: ׳ה + מושג׳ (ה"א היא האות הראשונה בתוך הגרש)
תקן: הוצא את ה"א לפני הגרש הפותח, מחק אותה מבפנים.
  'הדמוקרטיה' ← שגוי    →    ה'דמוקרטיה' ← נכון
  'הברית היהודית' ← שגוי →    ה'ברית היהודית' ← נכון
  'הימין' ← שגוי          →    ה'ימין' ← נכון

שלב ג׳ — בדוק כפילות ה"א (שגיאת יישום שכיחה):
סרוק ומצא: ה + ׳ה + מושג׳ (שתי ה"א — אחת מחוץ ואחת בתוך)
תקן: השאר רק ה"א אחת מחוץ לגרש, מחק מבפנים.
  ה'הברית היהודית' ← שגוי →    ה'ברית היהודית' ← נכון
  ה'הימין' ← שגוי           →    ה'ימין' ← נכון
...
━━━ כינוי גוף חסר (copula) ━━━
סרוק כל משפט: אם נושא (שם עצם / ביטוי שמני) ונשוא (שם עצם) מופיעים רצוף ללא פועל ביניהם — הוסף כינוי גוף.
בחר הוא/היא/הם/הן לפי מין ומספר הנושא.
  "שיטת משטרה שלה אוליגרכיה" → "שיטת משטרה שלה היא אוליגרכיה"
  "ששיטת המשטרה שלה דמוקרטית" → "ששיטת המשטרה היא דמוקרטית"
  "הצבא כלי" → "הצבא הוא כלי"
  "החברים אנשי מקצוע" → "החברים הם אנשי מקצוע"
...
ב. גרש שלב א׳ — האם יש עדיין [ב/ל/כ/מ]+ה+׳...׳ ? אם כן — תקן.
ג. גרש שלב ב׳ — האם יש עדיין ׳ה+מושג׳ ? אם כן — תקן.
ד. גרש שלב ג׳ — האם יש עדיין ה+׳ה+מושג׳ ? אם כן — תקן.
ה. כינוי גוף — האם יש משפט שנושא ונשוא שמניים רצופים ללא פועל? אם כן — הוסף.
ו. אם נמצא תיקון נוסף — בצע אותו.
