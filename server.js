...
לגבי התגיות (tags) - בחר 4 עד 6 תגיות מהרשימה הבאה. השתמש בניסוח המדויק כפי שמופיע ברשימה — ללא מקפים בין מילים. רק אם אין תגית מתאימה בכלל — אפשר ליצור אחת חדשה (גם ללא מקפים):
